...
Прогон верификации шаблонов — `PYTHONPATH=scripts uv run --with denodo-sqlalchemy --with
psycopg2-binary scripts/denodo verify --env lab`. Сам инструмент: `scripts/denodo --help`.
