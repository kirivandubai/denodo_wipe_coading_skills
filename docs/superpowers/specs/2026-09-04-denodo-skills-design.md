...
**Дата:** 2026-09-04
**Статус:** дизайн утверждён; реализация идёт — слой исполнения (раздел 7) сделан в T5, навык `execute` — в T7, ядро `/denodo:vql` (раздел 6) — в T6, доменные навыки `catalog` (T8a), `datasources` (T8b) и `views` (T8c) — по разделу 8; впереди `marketplace` и `query`
