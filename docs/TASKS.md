...
**Статус:** ждёт (T8d; T8a, T8b и T8c закрыты)
...
подкоманда `verify` как повторяемый прогон и marketplace-шаблоны: `views` проставлены
`verified:` по ходу T8c на demo-стенде 9.5.1.
